        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShopAdditionalAddressInfo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShopStreet = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShopCity = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShopCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShopState = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShopPostalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerDatas", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_SellerDatas_SellerId",
                        column: x => x.SellerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdditionalInfos_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdditionalInfos_ProductId",
